...
const CommandList = ({
  ...
  return items.length > 0 ? (
    <div
      ...
      className="bg-background z-50 h-auto max-h-[330px] w-72 overflow-y-auto rounded-md border px-1 py-2 shadow-md transition-all"
    >
      {items.map((item: CommandItemProps, index: number) => {
        return (
          <button
            className={`text-foreground hover:bg-background/20 flex w-full items-center space-x-2 rounded-md px-2 py-1 text-left text-sm ${
